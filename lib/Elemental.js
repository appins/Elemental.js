...
// Remeber to update the files in min before pushing
...
// Delete an element, this is a bit hard
Element.prototype.eDelete = function eDelete () {
...
//Instructions, all credit to CrazyGuy108
	var PublicEasyInstructions = "Thank you for using Elemental.js! <br> GitHub.com/AppIns/Elemental.js <br><br> If you know Elemental.js and want to use it,<br> Change window.onload to any value <br> after Elemental.js is loaded <br><br> If you are new to Elemental.js and decided to put it in your javascript, keep reading <br><br> Elemental.js makes DOM element manipulation easy! <br><br> var p = new Element(\"P\");<br> will create a new p element <br><br> p.eAppendTo(eSel(\"body\"));<br>Will insert the p element to the bottom of the document body <br><br> Read more on GitHub.com/AppIns/Elemental.js <br><br><br> This project will be updated frequently<br>please use the most up to date version<br><br>";
  ...
  // The title
	var eInsP = new Element("P");
	  	...
	  	eInsP.eProperty("innerHTML", "Elemental.js has been set up");
	  	eInsP.eStyle("paddingTop", "9px");
	  	eInsP.eStyle("fontSize", "27px");

  var problem = new Element("P");
      problem.eQuick("problem", eSel("#EleIns"), "If this is not your project and you see this <br> or this is your project and you set window.onload <br> There has been an error");
      problem.eStyle("fontSize", "14px");
